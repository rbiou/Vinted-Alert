    ...
    try:
        ...
        for index, row in data.iterrows():
            ...
            for item in data:
                ...
                reqDetailsAPI = Request(url="https://www.vinted.fr/api/v2/items/" + itemId + "?localize=false", headers={'User-Agent': 'Mozilla/5.0', 'cookie': 'anon_id=bff8fff8-62bc-49c4-86e8-5ba59740a5e0'})
